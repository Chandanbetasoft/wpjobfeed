 ...
 */
function wpjf_setting_input_type_text( $setting, $value ) {
...
add_action( 'wpjf_setting_type_text', 'wpjf_setting_input_type_text', 10, 2 );
 ...
 * @param  mixed $value   the current value of this setting saved in the database.
 */
function wpjf_setting_input_type_textarea( $setting, $value ) {
...
add_action( 'wpjf_setting_type_textarea', 'wpjf_setting_input_type_text', 10, 2 );
 ...
 * @param  mixed $value   the current value of this setting saved in the database.
 */
function wpjf_setting_input_type_select( $setting, $value ) {
...
add_action( 'wpjf_setting_type_select', 'wpjf_setting_input_type_select', 10, 2 );
 ...
 * @param  mixed $value   the current value of this setting saved in the database.
 */
function wpjf_setting_input_type_checkbox( $setting, $value ) {
...
add_action( 'wpjf_setting_type_checkbox', 'wpjf_setting_input_type_checkbox', 10, 2 );
 ...
 * @param  mixed $value   the current value of this setting saved in the database.
 */
function wpjf_setting_input_type_license_key( $setting, $value ) {
...
add_action( 'wpjf_setting_type_license_key', 'wpjf_setting_input_type_license_key', 10, 2 );
 ...
 * @param  mixed $value   the current value of this setting saved in the database.
 */
function wpjf_setting_input_type_section( $setting, $value ) {
...
add_action( 'wpjf_setting_type_license_section', 'wpjf_setting_input_type_section', 10, 2 );
